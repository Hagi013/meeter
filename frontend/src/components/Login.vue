<template lang='pug'>
  .login
    ...
    .container
      ...
      .lock-body
        .pull-left.lock-avatar-block
          img.lock-avatar(src='http://keenthemes.com/preview/metronic/theme/assets/admin/pages/media/profile/photo3.jpg')
        .lock-form.pull-left
          h4 Amanda Smith
          .form-group
            input.form-control/placeholder-no-fix(type='password' autocomplete='off' placeholder='Password' name='password')
          .form-actions
            button.btn.btn-success.uppercase(type='submit') Login
      .lock-bottom
        a(href='/') Not Amanda Smith?
